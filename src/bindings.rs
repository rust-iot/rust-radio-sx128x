...
pub const RADIO_DIO1_ENABLE: u32 = 1;
pub const RADIO_DIO2_ENABLE: u32 = 0;
pub const RADIO_DIO3_ENABLE: u32 = 0;
...
extern "C" {
    pub fn SX1280HalWaitOnBusy(sx1280: *mut SX1280_t);
}
extern "C" {
    pub fn SX1280HalInit(sx1280: *mut SX1280_t, irqHandlers: *mut DioIrqHandler);
}
extern "C" {
    pub fn SX1280HalIoInit(sx1280: *mut SX1280_t);
}
extern "C" {
    pub fn SX1280HalReset(sx1280: *mut SX1280_t);
}
extern "C" {
    pub fn SX1280HalClearInstructionRam(sx1280: *mut SX1280_t);
}
extern "C" {
    pub fn SX1280HalWakeup(sx1280: *mut SX1280_t);
}
extern "C" {
    pub fn SX1280HalWriteCommand(sx1280: *mut SX1280_t, opcode: u8, buffer: *mut u8, size: u16);
}
extern "C" {
    pub fn SX1280HalReadCommand(sx1280: *mut SX1280_t, opcode: u8, buffer: *mut u8, size: u16);
}
extern "C" {
    pub fn SX1280HalWriteRegisters(sx1280: *mut SX1280_t, address: u16, buffer: *mut u8, size: u16);
}
extern "C" {
    pub fn SX1280HalWriteRegister(sx1280: *mut SX1280_t, address: u16, value: u8);
}
extern "C" {
    pub fn SX1280HalReadRegisters(sx1280: *mut SX1280_t, address: u16, buffer: *mut u8, size: u16);
}
extern "C" {
    pub fn SX1280HalReadRegister(sx1280: *mut SX1280_t, address: u16) -> u8;
}
extern "C" {
    pub fn SX1280HalWriteBuffer(sx1280: *mut SX1280_t, offset: u8, buffer: *mut u8, size: u8);
}
extern "C" {
    pub fn SX1280HalReadBuffer(sx1280: *mut SX1280_t, offset: u8, buffer: *mut u8, size: u8);
}
extern "C" {
    pub fn SX1280HalGetDioStatus(sx1280: *mut SX1280_t) -> u8;
}
extern "C" {
    pub fn SX1280HalIoIrqInit(sx1280: *mut SX1280_t, irqHandlers: *mut DioIrqHandler);
}
pub type SpiWrite = ::core::option::Option<
    unsafe extern "C" fn(
        ctx: *mut libc::c_void,
        prefix: *mut u8,
        prefix_len: u16,
...
>;
pub type SpiRead = ::core::option::Option<
    unsafe extern "C" fn(
        ctx: *mut libc::c_void,
        prefix: *mut u8,
        prefix_len: u16,
...
>;
pub type PinSet =
    ::core::option::Option<unsafe extern "C" fn(ctx: *mut libc::c_void, value: bool) -> i32>;
pub type PinGet = ::core::option::Option<unsafe extern "C" fn(ctx: *mut libc::c_void) -> i32>;
pub type DelayMs = ::core::option::Option<unsafe extern "C" fn(ctx: *mut libc::c_void, ms: u32)>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct SX1280_s {
    pub ctx: *mut libc::c_void,
    pub spi_read: SpiRead,
    pub spi_write: SpiWrite,
    pub set_reset: PinSet,
    pub get_busy: PinGet,
    pub get_dio: [PinGet; 4usize],
...
fn bindgen_test_layout_SX1280_s() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<SX1280_s>())).spi_read as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(SX1280_s),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<SX1280_s>())).spi_write as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(SX1280_s),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<SX1280_s>())).set_reset as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(SX1280_s),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<SX1280_s>())).get_busy as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(SX1280_s),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<SX1280_s>())).get_dio as *const _ as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(SX1280_s),
