...
SX1280HalGetRxBufferStatus( sx1280, size, &offset );
    if( *size > maxSize )
    {
        return 1;
    }
...
{
SX1280HalSetPayload( sx1280, payload, size );
SX1280HalSetTx( sx1280, timeout );
}
...
{
SX1280HalSetBleAccessAddress( sx1280, BLE_ADVERTIZER_ACCESS_ADDRESS );
}
...
void SX1280ProcessIrqs( SX1280_t *sx1280)
{
    ...
    SX1280HalClearIrqStatus( sx1280, IRQ_RADIO_ALL );
