 ...
 */
void SX1280HalWriteCommand( SX1280_t *sx1280, RadioCommands_t opcode, uint8_t *buffer, uint16_t size );
 ...
 */
void SX1280HalReadCommand( SX1280_t *sx1280, RadioCommands_t opcode, uint8_t *buffer, uint16_t size );
